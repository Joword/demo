...
import { RegisterInfo, emailCodeForm, loginForm, changePassword, chatForm, ChatPaperConversation } from "@/types/info";
...
export const getVariantId = (arg: any) => {
...
export const getSessionId = (arg: string | any) => {
    return axios.post(ApiList.getSessionId + `?u=${arg}`);
}
...
export const getPaperHighlightShowing = (arg: any) => {
    return axios.post(ApiList.paperHighLightShowing, arg)
}

export const addPaperHighlight = (arg: any) => {
    return axios.post(ApiList.paperHighlightAdd, arg)
}

export const addImgPaperHighlight = (arg: any) => {
    return axios.post(ApiList.paperHighlightImgAdd, arg)
}

export const deletePapaerHightlight = (arg: any) => {
    return axios.post(ApiList.paperHighlightDelete, arg)
}

export const getPaperContent = (param: chatForm)=> {
    return axios.post(ApiList.paperContent, param)
}

export const getChatApi = (arg: ChatPaperConversation) => {
    return axios.post(ApiList.chatPaperConversation, arg);
}

export const getPaperCriteriaShowing = (arg: any) => {
    return axios.post(ApiList.paperShowing, arg)
}

export const updatePaperCriteria = (arg: any) => {
    return axios.post(ApiList.paperUpdateCriteria, arg);
}
