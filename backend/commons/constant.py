...
class ResultCode(str, Enum):
    ...
    RESULT_SUCC = 1000
    # 服务异常
    SERVER_EXCEPTION = 1100
    SOCKET_EXCEPTION = 1200
    # req参数相关
    USERNAME_ISEXIST = 2001
    VARIANTID_ISEXIST = 2002
    VARIANTID_NONEXIST = 2002
    USERNAME_NONEXIST = 2003
    GENOMEVERSION_ISEXIST = 2004
    GENOMEVERSION_NONEXIST = 2005
    ACMGVERSION_ISEXIST = 2006
    ACMGVERSION_NONEXIST = 2007
    PASSWORD_NONEXIST = 2008
    PMID_NONEXIST = 2009
    EMAIL_NONEXIST = 2010
    EMAIL_CODE_NONEXIST = 2011
    EMAIL_CODE_ERROR = 2012
    PASSWORD_ERROR = 2013
    # 数据异常
    DATA_NONEXIST = 5000
    DATA_ISEXTRA = 5001
